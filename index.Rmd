...
In order to calculate attributable IHD-numbers, I still need the used prevalence data used in the HLNUG calculations.
...
The picture of HSD-numbers is more diverse: The differences between the HSD-numbers calculated account to always less than $\pm 0,5$ in most  (`casesOKHSD`) cases, however in `r casesbigDiffHSD` cases, the difference between the two calculations amounts to up to a difference of 90 for a single municipality.
